...
import type { AgentStoredMessage, AgentMessage, CodexReasoningEffort } from 'webpage-mcp-shared';
...
const currentManagementInfo = ref<import('webpage-mcp-shared').AgentManagementInfo | null>(null);
