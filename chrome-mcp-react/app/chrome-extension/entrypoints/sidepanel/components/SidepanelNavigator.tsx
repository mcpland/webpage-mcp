        ...
        <div className="navigator-overlay" onClick={closeMenu}>
          <div className="navigator-menu" onClick={(event) => event.stopPropagation()}>
            <div className="navigator-header">
              <span className="navigator-title">切换页面</span>
            ...
            <div className="navigator-items">
              <button
                className={`navigator-item${activeTab === 'agent-chat' ? ' navigator-item-active' : ''}`}
                onClick={() => selectTab('agent-chat')}
                type="button"
              >
                ...
                <div className="navigator-item-content">
                  <span className="navigator-item-title">智能助手</span>
                  <span className="navigator-item-desc">AI Agent 对话与任务</span>
                </div>
              ...
              >
                ...
                <div className="navigator-item-content">
                  <span className="navigator-item-title">工作流管理</span>
                  <span className="navigator-item-desc">录制与回放自动化流程</span>
                </div>
                {activeTab === 'workflows' ? (
                  <div className="navigator-item-check">
                    <svg
              ...
              >
                ...
                <div className="navigator-item-content">
                  <span className="navigator-item-title">元素标注管理</span>
                  <span className="navigator-item-desc">管理页面元素标注</span>
                </div>
