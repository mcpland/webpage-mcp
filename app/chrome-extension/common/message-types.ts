...
export const BACKGROUND_MESSAGE_TYPES = {
  ...
  GET_SERVER_INSTANCES: "get_server_instances",
  UPSERT_SERVER_INSTANCE: "upsert_server_instance",
  REMOVE_SERVER_INSTANCE: "remove_server_instance",
  START_SERVER_INSTANCE: "start_server_instance",
  STOP_SERVER_INSTANCE: "stop_server_instance",
  ...
  RR_RECORDING_STATE_CHANGED: "rr_recording_state_changed",
...
export interface SemanticEngineInitMessage {
  target: MessageTarget.Offscreen;
  type: typeof OFFSCREEN_MESSAGE_TYPES.SIMILARITY_ENGINE_INIT;
  config: unknown;
  /** Required whenever initialization would replace or create an engine. */
  attemptId?: string;
}

export interface SemanticModelProgressMessage {
  type: typeof BACKGROUND_MESSAGE_TYPES.UPDATE_MODEL_STATUS;
  attemptId: string;
  modelState: unknown;
}
...
export const PRIVILEGED_UI_ACTIONS = {
  ...
  WEB_EDITOR_OPEN_SOURCE: "web_editor_open_source",
  WEB_EDITOR_REGISTER_PROPS_INJECTION:
    "web_editor_register_props_injection",
} as const;
