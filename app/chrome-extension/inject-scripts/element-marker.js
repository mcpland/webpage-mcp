    ...
    const PANEL_TEMPLATE = `
      <div class="em-panel" id="em_panel_root">
        ...
        <div class="em-header em-drag-handle" id="__em_drag_handle" title="Drag to move">
          <h2 class="em-title">Element annotation</h2>
        ...
        <div class="em-controls">
          ...
          <button class="em-square-btn" id="__em_toggle_list" title="List mode - annotate similar elements in batches (only supports CSS)">
            <svg viewBox="0 0 24 24">
    ...
    try {
      ...
      if (res?.tool?.ok) {
        StateStore.set({
          validation: {
            status: 'success',
            message: `✓ Verification successful (matches ${filteredMatches.length} elements)`,
          },
