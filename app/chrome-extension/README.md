...
The user-script manager also requires a Chrome-controlled opt-in. In Chrome
...
These toggles affect the user-script manager; they do not lower the Connector's
Chrome 135 minimum.
