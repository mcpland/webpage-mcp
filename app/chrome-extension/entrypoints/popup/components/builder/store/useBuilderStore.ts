...
export function useBuilderStore(initial?: FlowV2 | null) {
  ...
  // Alternate layout: layered + gravity sorting (no reliance on external libraries)
  ...
  // Automatic typesetting (ELK priority):
  // - Dynamically introduce elkjs to avoid resident volume
  // - On failure, fallback to layoutFallback()
