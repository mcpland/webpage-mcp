...
/**
 * Create the Web Editor instance.
 *
 * This is the main factory function that creates the editor API.
 * The returned object implements WebEditorApi and is exposed on window.__MCP_WEB_EDITOR__
 */
export function createWebEditor(): WebEditorApi {
  ...
  function cancelEdit(): void {
    ...
    restoreEditTarget(session);
    console.log(`${WEB_EDITOR_LOG_PREFIX} Text edit cancelled`);
  }
  ...
  function startEdit(element: Element, modifiers: EventModifiers): boolean {
    ...
    console.log(`${WEB_EDITOR_LOG_PREFIX} Text edit started`);
    return true;
  }
  ...
  function handleDeselect(): void {
    ...
    console.log(`${WEB_EDITOR_LOG_PREFIX} Deselected`);
  }
  ...
  function handleTransactionChange(event: TransactionChangeEvent): void {
    ...
    console.log(
      `${WEB_EDITOR_LOG_PREFIX} Transaction: ${action} (undo: ${undoCount}, redo: ${redoCount})`,
    );
  ...
  async function revertElement(
    ...
    try {
      ...
      console.error(`${WEB_EDITOR_LOG_PREFIX} Revert element failed:`, error);
      return {
        success: false,
  ...
  function clearSelection(): void {
    ...
    console.log(`${WEB_EDITOR_LOG_PREFIX} Selection cleared (from sidepanel)`);
  }
  ...
  function stop(): Promise<void> {
    ...
    try {
      ...
      console.error(`${WEB_EDITOR_LOG_PREFIX} Error during cleanup:`, error);
